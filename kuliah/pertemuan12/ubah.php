  ...
  <div class="row mt-3">
    <div class="col-8">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="npm" name="npm" required value="<?php echo $mhs["npm"]; ?>" style="width: 120px;">
        </div>

        <div class="mb-3">
            <label for="email" class="form-label">Email</label>
            <input type="email" class="form-control" id="email" name="email" required value="<?php echo $mhs["email"]; ?>">
        </div>
