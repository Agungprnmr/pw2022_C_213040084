...
<html>
	...
	<body>
		...
		<section class="banner" id="Home">
			<div class="container">
				<div class="banner-left">
					...
					<h2 class="home">Hai Guys....</br>
					Ulasan Film <span class="efek-ngetik"></span></h2>
					<h1>Selamat datang di website Mintira Movies</h1>
			</div>
		</section>
		...
		<section id="About">
			<div class="container">
				<h3>Mintira Movies</h3>
				<p>Ulasan - Ulasan Film Dengan Kualitas Terbaik</p>
			</div>
		</section>
    ...
    <h3 class="sub-heading"> Rekomendasi Movies</h3>
		<div class="box-container">
        	<?php foreach ($entertainment as $ent) :?>
                ...
                <div class="box">
                <img src="../img/<?= $ent['gambar'] ?>"alt="...">
                <h3><?= $ent['nama'] ?></h3>

                <div class="starts">
                </div> 
                <a href="login1.php" class="btn"> Detail </a>
            	</div>
        	<?php endforeach; ?>
		</div>
</section>
