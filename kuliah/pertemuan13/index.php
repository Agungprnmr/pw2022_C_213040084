            ...
            <tbody>
                <?php $i=1; foreach ($mahasiswa as $mhs) { ?>
                    <tr>
                        <th scope="row"><?= $i++;?></th>
                        <td>
                            <img src="img/<?php echo $mhs["gambar"]; ?>" height="100" class="rounded-circle">
                        </td>
                        ...
                        <td>
                            ...
                            <a href="hapus.php?id=<?= $mhs["id"]; ?>" class="btn badge bg-danger" onclick="return confirm('Yang Beneeerrr');">Hapus</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
